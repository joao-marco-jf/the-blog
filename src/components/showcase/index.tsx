                ...
                <Smooth.section speed="-.25">
                    ...
                    <Smooth.fragment className="z-50 flex w-full gap-[2rem]">
                        ...
                        <div className="flex flex-col w-full py-[2rem] gap-[1rem]">
                            ...
                            <Link className="w-fit font-light text-[1.6rem] tracking-tighter underline text-zinc-700 hover:underline hover:text-black" href={`/article/${props.articles[0].slug}`}>Ler artigo</Link>
                        </div>
                    </Smooth.fragment>
                </Smooth.section>
            )
                ...
                <Smooth.section speed="-.25">
                    ...
                    <Smooth.fragment className="z-50 flex w-full gap-[2rem]">
                        ...
                        >
                            ...
                            <Link className="w-fit font-light text-[1.6rem] tracking-tighter underline text-zinc-700 hover:underline hover:text-black" href={`/article/${props.articles[1].slug}`}>Ler artigo</Link>
                            </div>
                        </div>
                    </Smooth.fragment>
                </Smooth.section>
